                    ...
                    <form name="sentMessage" id="contactForm" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input name="subject" type="text" class="form-control" placeholder="Your subject *" id="subject" required data-validation-required-message="Please enter your message subject">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
